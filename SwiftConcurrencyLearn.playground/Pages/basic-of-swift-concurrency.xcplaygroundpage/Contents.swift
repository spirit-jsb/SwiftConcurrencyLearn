...
example("synchronous appending value to string") {
  var results: [String] = []
...
example("synchronous load signature from remote (blocking actions)") {
  // 从网络读取一个字符串
...
example("asynchronous load signature from remote") {
...
example("synchronous serial actions") {
  var results: [String] = []
...
example("asynchronous serial actions") {
  var results: [String] = []
...
asyncExample("using async function to load signature from remote") {
...
///
///
asyncExample("using async function to asynchronous serial actions") {
  var results: [String] = []
